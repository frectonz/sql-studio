...
```bash
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/frectonz/sql-studio/releases/download/0.1.49/sql-studio-installer.sh | sh
```

### Install prebuilt binaries via powershell script

```powershell
powershell -ExecutionPolicy Bypass -c "irm https://github.com/frectonz/sql-studio/releases/download/0.1.49/sql-studio-installer.ps1 | iex"
```
