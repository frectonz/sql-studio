...
export default function LandingPage() {
  return (
    <div
      className="ld-mono ld-bg"
      style={{ color: "var(--ss-foreground)", minHeight: "100vh" }}
    >
      {/* NAV */}
      <nav style={{ borderBottom: "2px solid var(--ss-border)" }}>
        <div className="tw:mx-auto tw:flex tw:h-14 tw:max-w-6xl tw:items-center tw:justify-between tw:px-6">
          ...
          <div
            className="tw:flex tw:items-center tw:gap-6 tw:text-xs tw:tracking-widest"
            style={{ color: "var(--ss-muted)" }}
          >
            <Link
              href="/docs"
              className="tw:transition-colors tw:duration-100 tw:hover:text-white"
            >
              DOCS
            </Link>
            <Link
      ...
      <section
        ...
        style={{ borderBottom: "2px solid var(--ss-border)" }}
      >
        <div
        ...
        <div className="tw:relative tw:z-10 tw:mx-auto tw:grid tw:max-w-6xl tw:grid-cols-1 tw:lg:grid-cols-[2fr_3fr]">
          {/* Left — text */}
          <div
            className="tw:px-6 tw:pb-16 tw:pt-20 tw:md:pb-24 tw:md:pt-28"
            style={{ borderRight: "none" }}
          >
            <Link
              href="https://github.com/frectonz/sql-studio/releases/tag/0.1.51"
            ...
            <h1
              className="ld-up tw:font-black tw:text-6xl tw:sm:text-7xl tw:md:text-8xl tw:lg:text-9xl"
              style={{
                animationDelay: "0.2s",
                lineHeight: 0.85,
            ...
            >
              SQL
              <br />
              <span style={{ color: "var(--ss-primary)" }}>Studio</span>
            </h1>
            ...
            <div
              className="ld-up tw:mt-8 tw:flex tw:flex-wrap tw:gap-3"
              style={{ animationDelay: "0.45s" }}
            >
              <Link
                href="/docs/installation"
                className="tw:inline-flex tw:items-center tw:gap-2 tw:border tw:px-5 tw:py-2.5 tw:text-sm tw:font-bold tw:uppercase tw:tracking-wider tw:transition-all tw:duration-100 tw:hover:translate-x-[-1px] tw:hover:translate-y-[-1px] tw:hover:shadow-[2px_2px_0_hsl(159,100%,50%)]"
                style={{
              ...
              <Link
                href="https://sql-studio.frectonz.et/"
                className="tw:inline-flex tw:items-center tw:gap-2 tw:border tw:px-5 tw:py-2.5 tw:text-sm tw:font-bold tw:uppercase tw:tracking-wider tw:transition-all tw:duration-100 tw:hover:translate-x-[-1px] tw:hover:translate-y-[-1px] tw:hover:shadow-[2px_2px_0_hsl(159,50%,15%)]"
                style={{
          ...
          <div
            className="ld-up tw:flex tw:items-center tw:justify-center tw:pb-16 tw:pt-8 tw:lg:pb-24 tw:lg:pt-28"
            style={{ animationDelay: "0.5s", perspective: "1200px" }}
          >
            <div
              className="ld-hero-tilt"
              style={{
            ...
            >
              <img
                src="/overview.png"
                alt="SQL Studio overview dashboard"
                className="tw:block tw:w-full tw:object-contain"
              />
            </div>
          </div>
        </div>
      ...
      >
        <div
          className="ld-watermark"
          style={{ fontSize: "25vw", bottom: "-5%", right: "-3%" }}
        >
          SELECT&nbsp;*
        </div>
        <div className="tw:relative tw:z-10 tw:mx-auto tw:max-w-6xl tw:px-6 tw:py-20 tw:md:py-28">
          <div className="ld-scroll tw:mb-2">
            <span
              className="tw:text-xs tw:font-bold tw:tracking-widest"
          ...
          <p
            className="ld-scroll tw:mb-12 tw:max-w-md tw:text-sm"
            style={{ color: "var(--ss-muted-dim)" }}
          >
            From local SQLite files to remote PostgreSQL clusters. Same
            interface, same command.
          </p>
          ...
          >
            {DATABASES.map((db) => (
              ...
              >
                ...
                <div
                  className="tw:mb-1.5 tw:text-xs"
                  style={{ color: "var(--ss-primary)" }}
                >
                  {db.command}
                </div>
      ...
      >
        <div
          className="ld-watermark"
          style={{ fontSize: "30vw", top: "10%", left: "-5%" }}
        >
          JOIN
        </div>
        <div className="tw:relative tw:z-10 tw:mx-auto tw:max-w-6xl tw:px-6 tw:py-20 tw:md:py-28">
          ...
          <p
            ...
            style={{ color: "var(--ss-muted-dim)" }}
          >
            Overview dashboards, table browsers, a full SQL editor, and
            ...
            {FEATURES.map((feature, i) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className="tw:border-t tw:px-4 tw:py-3 tw:md:px-5 tw:md:py-4"
                    style={{ borderColor: "var(--ss-border)" }}
                  >
                    <div
                      className="tw:mb-1.5 tw:inline-block tw:border tw:px-2 tw:py-0.5 tw:text-xs tw:font-black tw:tracking-widest"
                      style={{
                        borderColor: "var(--ss-primary)",
                        color: "var(--ss-primary)",
                      }}
                    ...
                    <p
                      className="tw:mt-1.5 tw:text-xs tw:leading-relaxed"
                      style={{ color: "var(--ss-muted)" }}
                    >
                      {feature.description}
                    </p>
      ...
      <section style={{ borderBottom: "2px solid var(--ss-border)" }}>
        <div className="tw:mx-auto tw:max-w-6xl tw:px-6 tw:py-20 tw:md:py-28">
          ...
          <div className="tw:grid tw:grid-cols-1 tw:gap-4">
            {INSTALL_METHODS.map((method) => (
              <div key={method.label} className="ld-install ld-scroll">
                <div
                  className="tw:flex tw:items-center tw:justify-between tw:border-b tw:px-4 tw:py-2"
                  style={{ borderColor: "var(--ss-border)" }}
                >
                  <span
                    className="tw:text-xs tw:font-black tw:tracking-widest"
                    style={{ color: "var(--ss-muted-dim)" }}
                  >
                    {method.label}
                  </span>
                ...
                <div className="tw:px-4 tw:py-4">
                  <code
                    className="tw:block tw:whitespace-pre-wrap tw:break-all tw:text-xs tw:leading-relaxed"
                    style={{ color: "var(--ss-primary)" }}
                  >
                    $ {method.command}
                  </code>
          ...
          <div
            className="ld-scroll tw:mt-10"
            style={{ color: "var(--ss-muted-dim)" }}
          >
            <p className="tw:text-sm">
              Or try the built-in preview:{" "}
              <code
                className="tw:border tw:px-2 tw:py-0.5 tw:text-xs"
                style={{
                  borderColor: "var(--ss-border)",
                  color: "var(--ss-primary)",
                }}
      ...
      <footer className="tw:px-6 tw:py-12">
        <div className="tw:mx-auto tw:flex tw:max-w-6xl tw:flex-col tw:items-center tw:gap-5 tw:md:flex-row tw:md:justify-between">
          ...
          <div
            className="tw:flex tw:gap-6 tw:text-xs tw:tracking-widest"
            style={{ color: "var(--ss-muted-dim)" }}
          >
            <Link
              href="/docs"
            ...
            <Link
              href="https://github.com/frectonz/sql-studio/releases"
              className="tw:transition-colors tw:duration-100 tw:hover:text-white"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <span className="tw:text-xs" style={{ color: "var(--ss-border)" }}>
            RUST + REACT
          </span>
        </div>
      </footer>
